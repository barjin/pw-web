...
/**
 * Test for /recording/{id}
 */
Test('/recording/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getRecording get operation', function (t) {
            Mockgen().requests({
                path: '/recording/{id}',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/recording/{id}']['get']['responses']['200']['schema']);
